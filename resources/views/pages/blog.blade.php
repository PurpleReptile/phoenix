...
<div class="center_div">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8">
                <div id="block_blog" class="content">
                    <div class="title_blog">
                        <h2>Заголовок</h2>
                    </div>
                    <div class="info_about_blog">
                        <p>Тема: 
                            <a class="link_blog" title="авто">авто</a>,
                            <a class="link_blog" title="природа">природа</a>,
                            <a class="link_blog" title="интернет">интернет</a> 
                        </p>
